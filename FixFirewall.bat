...
netsh advfirewall firewall add rule name="AntiSwearingChatBox" dir=in action=allow protocol=TCP localport=5122-5128 program=ANY enable=yes profile=any description="Allow AntiSwearingChatBox communication"
